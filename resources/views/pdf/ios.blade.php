    ...
    <div class="container">
        <div class="row mt-1">
            ...
            <div class="mb-1">
                <div class="row">
                    <div class="col-md-7">
                        <p>ชื่อ-นามสกุล: <span class="fw-bolder">น.ส.นวินดา สีหาเวช</span></p>
                    </div>
                    <div class="col-md-4">
                        <p class="ps-4">เลขบัตร : <span class="fw-bolder">1330400106243</span></p>
                    </div>
                </div>

                <div class="row">
                    <div class="col-md-7">
                        <p>ที่อยูปัจบัน : <span class="fw-bolder">7/6 ม.9 ซ.วันเพ็ญ ต.สำโรงใต้ อ.พระประแดง 33130</span>
                        </p>
                    </div>
                    <div class="col-md-4">
                        <p class="ps-4">เบอร์หลัก : <span class="fw-bolder">0928253049</span></p>
                    </div>
                </div>

                <div class="row">
                    <div class="col-md-7">
                        <p>ที่ทำงาน : <span class="fw-bolder">ร้านเสื้อผ้า ชัน3 ห้างอิมพีเรียลสำโรง</span></p>
                    </div>
                    <div class="col-md-4">
                        <p class="ps-4">เบอร์อ้างอิง : <span class="fw-bolder">0642911065.</span></p>
                    </div>
                </div>
            </div>
            ...
            <p class="mb-1" style="text-indent: 50px;">
                ...
                และผู้เช่าซื้อตกลงเช่าซื้อทรัพย์สินและชำระค่างวดตามรายการทรัพย์สินที่เช่าซื้อในบัญชีรายการเช่าซื้อด้านล่างนี้
            </p>
            ...
            <table class="table table-bordered border-secondary">
                <thead>
                    <tr class="bg-gray">
                        ...
                        <td class="bg-gray" style="width: 20%;">
                            <p>จำนวนเงิน</p>
                        </td>
                        <td class="bg-gray" style="width: 20%;">
                            <p>กำหนดชำระ</p>
                        </td>
                        <td class="bg-gray" style="width: 28%;">
                            <p>สถาณะ</p>
                        </td>
                        <td class="bg-gray" style="width: 20%;">
                            <p>วันที่ชำระ</p>
                ...
                <tbody>
                    @for ($i = 1; $i < 13; $i++)
                        <tr>
                            <td>
                                <p class="text-center fw-bold">{{ $i }}</p>
                            </td>
                            <td>
                                <p class="text-center fw-bold">1,000</p>
                            </td>
                            <td>
                                <p class="text-center fw-bold">10/10/2024</p>
                            </td>
                            <td>
                                <p class="text-center fw-bold">{{ '<โอน>' }}</p>
                            </td>
                            <td>
                                <p class="text-center fw-bold">{{ '<10/10/2024>' }}</p>
                            </td>
            ...
            <div class="tac mb-1">
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <p class="ps-1">ผูเ้ ช่าซื้อจะต้องชำระเงินตามระยะเวลาที่ทางผูใ้
                                            ห้เช่าซื้อกำหนดให้
                                            กรณีไม่อยากผ่อนต่อสามารถส่งคืนร้านเพื่อรับเงินดาวน์คืนตามเงื่อนไข ที่ทางผูใ้
                                            ห้เช่าซื้อกำหนด และสินค้าต้องอยูใ่ นสภาพที่สมบูรณ์ หากสินค้าชำรุดเสียหาย
                                            หรือเป็นรอย ผูเ้ ช่าซื้อยินยอมชดใช้ค่าเสียหาย</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <p class="ps-1">เกินกำหนดชำระ จะมีค่าปรับวันละ 50 บาท กรณีค้างชำระเกิน 7 วัน
                                            ทางผูใ้ ห้เช่าซื้อจะลบข้อมูลและล็อคเครื่อง ไม่สามารถเข้าใช้งานได้
                                            ลูกค้าต้องส่งมาปลดล็อค มีค่าปลดล็อค 500-1000 บาท</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <p class="ps-1">
                                            กรณีค้างชำระเกิน 15 วัน ให้ถือว่าผูเ้ ช่าซื้อผิดสัญญา ทางผูใ้
                                            ห้เช่าซื้อจะทำการเรียกสินค้าคืนจากผูเ้ ช่าซื้อ โดยผูเ้ ช่าซื้อจะต้องส่งคืน
                                            ...
                                            ผูเ้ ช่าซื้อ ยินยอมชำระคำทวงถามเป็นจำนวน 100 บาท หลังเกินกำหนดชำระ 5 วัน
                                            ต่อการทวงถามต่อ 1 งวด
                                ...
                                <tr>
                                    <td>
                                        <p style="color: red !important;">4.</p>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <p style="color: red !important;">5.</p>
                                    </td>
                                    <td>
                                        <p style="color: red !important;">
                                            กรณีค้างชำระเกิน 15 วัน ให้ถือว่าผูเ้ ช่าซื้อผิดสัญญา ทางผูใ้
                                ...
                                <tr>
                                    <td>
                                        <p style="color: red !important;">6.</p>
                                    </td>
                                    <td>
                                        <p style="color: red !important;">
                                            กรณีค้างชำระเกิน 15 วัน ให้ถือว่าผูเ้ ช่าซื้อผิดสัญญา ทางผูใ้
                        ...
                        <p style="color: red !important;text-align: center;">***ตามประมวลกฎหมายอาญามาตรา 352
                            ต้องโทษจำคุกไม่เกิน 3 ปี ***</p>
                        <p style="color: red !important;text-align: center;">
                            ***เมื่อใดที่ผเู้ช่าซื้อถูกดำเนินคดีตามกฎหมายผูเ้ช่าซื้อยินยอมรับผิดชอบค่าใช้จา่ยในการดำเนินคดีทังหมดทุกกรณึ***
                        </p>
                        <p style="color: blue !important;text-align: center;">
                            "เราดำเนินคดีจริงทุกเคสฝ่ายกฎหมายว่างพร้อมไปศาลได้ตลอดคุณละว่างไหมเสียงานเสียการฉะนันอย่าล้อเล่นกับระบบ"
                        </p>
                        <p style="color: blue !important;text-align: center;">ชำระเงิน โอนเข้าบัญชี 8541013291
                            ธนาคารกรุงศรี ชื่อ อัสนัย แก้วบำรุง เท่านัน</p>
                    </div>
                </div>
            </div>
